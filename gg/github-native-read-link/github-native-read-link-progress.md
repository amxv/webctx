...
| 2 | Issues, conversations, selectors, lists, labels, and relationships | complete | pending Phase 2 commit | Native Issue conversations/comment selectors plus bounded Issue/search/label/milestone views and current relationships are complete. |
...
- **Ending commit(s):** pending Phase 2 commit; replace after commit creation.
