...
`read-link` returns terminal-friendly markdown/text. Native GitHub repository/tree/Issue/list reads use compact metadata plus selected content; ordinary pages keep the title/URL/content shape.
